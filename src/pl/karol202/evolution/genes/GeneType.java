...
public enum GeneType
{
	...
	MAT(new float[] { 0.02f, 0.02f, 0.02f, 0.01f, 0.01f, 0.005f, 0.005f, -0.02f, -0.02f, -0.01f, -0.01f, -0.005f, -0.005f }), //Adolescence time
	...
	BRX(new float[] { 20, 15, 10, 8, 5, 5, 3, 2 }); //Max reproduce cooldown
